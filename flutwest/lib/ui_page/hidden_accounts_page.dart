                          ...
                          PageRouteBuilder(
                              pageBuilder: ((context, animation,
                                  ...
                                  AccountDetailPage(
                                      ...
                                      currAccount: widget
                                          .hiddenAccountOrderInfos[accountIndex]
                                          .account,
...
/*class HiddenAccountsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: ListView.builder(
            itemCount: hiddenAccountOrderInfos.length + 1,
            itemBuilder: ((context, index) {
              int accountIndex = index - 1;
              if (index == 0) {
                return Column(
              ...
              return StandardPadding(
                child: AccountButton(
                    leftTitle:
                        "Westpac ${hiddenAccountOrderInfos[accountIndex].account.type}",
                    rightTitle:
                        "\$${Utils.formatDecimalMoneyUS(hiddenAccountOrderInfos[accountIndex].account.balance)}",
                    ontap: () async {
                      await Navigator.push(
                          context,
                          PageRouteBuilder(
                              pageBuilder: ((context, animation,
                                      secondaryAnimation) =>
                                  AccountDetailPage(
                                      accounts: hiddenAccountOrderInfos,
                                      currIndex: accountIndex,
                                      ...
                                      currAccount:
                                          hiddenAccountOrderInfos[accountIndex]
                                              .account,
                                      memberId: memberId,
                                      recentPayeeDate: recentPayeeDate))));
                              ...
                              pageBuilder:
                                  ((context, animation, secondaryAnimation) =>
                                      HiddenAccountsPage(
                                          hiddenAccountOrderInfos:
                                              hiddenAccountOrderInfos,
                                          accountOrderInfos: accountOrderInfos,
                                          accounts: accounts,
                                          memberId: memberId,
                                          recentPayeeDate: recentPayeeDate))));
                    }),
